 ...
 */
public class CloudWatchTextSizeReporter extends ElasticBaseRichBolt {
    ...
    public void prepare(Map conf, TopologyContext topologyContext, OutputCollector collector) {
        ...
        logger.info("CloudWatch Text Reporter: Namespace = " + this.namespace);
    ...
    public void execute(Tuple tuple) {
        try{
            ...
            registry.counter(metricName).inc(text.length());
        }
        catch(Throwable t){
